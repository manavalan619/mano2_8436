...
DESKTOPCODE='../../../application/client/desktop/mano2_8436'
DESKTOPIMAGENAME='geppettotest/mano2_8436-desktop:1.0'
...
helm install --name mano2_8436 ./helm
if [ $? -eq 0 ]; then
